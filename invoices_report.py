...
class Invoice(models.TransientModel):
    ...
    def hraj_invoice(self):
        ...
        for settle in settlement_invoices:
            ...
            invoice_dict[f"invoice_{partner_id}"]['settle']['sub_total_settle'] += settle.price_unit * settle.qty
            invoice_dict[f"invoice_{partner_id}"]['settle']['tax_settle'] += settle.price_unit * settle.qty * 0.15
